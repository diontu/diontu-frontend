...
import { Tech, TechContainer, TechTitle, TechRow, TechPopup, TechPopupHeader} from './styles/TechStackStyles';
import { 
    SiReact,
    SiNodeDotJs,
    SiJava,
...
const techFrontendBackendDB = [
    ...
    { name: "Node.js", reason: "I use this often to create HTTP/RESTful APIs and other cool things.", Component: SiNodeDotJs },
    ...
    { name: "MongoDB", reason: "I use this often to persist data in a non-relational format.", Component: SiMongodb },
    { name: "PostgreSQL", reason: "I use this often to persist data in a relational format.", Component: SiPostgresql },
]
const techDevOps = [
    { name: "Git", reason: "I use this for version control.", Component: SiGit },
    { name: "Docker", reason: "I use this to efficiently deploy and run applications in different environments.", Component: SiDocker },
    { name: "Amazon Web Services", reason: "I use this for deploying and storing static content.", Component: SiAmazonaws },
...
const techOthers = [
    ...
    { name: "Confluence", reason: "What I use to document the things I learn.", Component: SiConfluence },
