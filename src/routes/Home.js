  ...
  render() {
    return (
      <div style={styles.pageDiv}>
        ...
        <p>
          This is my personal website where I showcase my projects and write blogs about technical topics
          and concepts I've learned or am currently learning.
        </p>
        <h3>About Me</h3>
        <p>
          I'm a web developer and a backend solutions enthusiast. I've worked as a
          ...
          School of Engineering at York University with expected graduation date of June 2021.
        </p>
        <p>
          I tend to use different technologies to help me build cool things while
          documenting my progress, but I generally use the following technologies:
        </p>
        <TechStack />
      </div>
    )
